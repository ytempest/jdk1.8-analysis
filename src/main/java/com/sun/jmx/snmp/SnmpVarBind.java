...
public class SnmpVarBind implements SnmpDataTypeEnums, Cloneable, Serializable {
     ...
     * @throws SnmpStatusException An error occurred while resolving the MIB variable name.
     */
     ...
     * @throws ClassCastException An attempt has been made to cast an object to a subclass of which
     ...
     * @throws IllegalArgumentException The specified value is negative or larger than <CODE>Long.MAX_VALUE</CODE>.
     * @see SnmpCounter64
     */
     ...
     * @throws IllegalArgumentException The specified value is negative or larger than
     ...
     * @throws IllegalArgumentException The specified value is neither a numeric <CODE>String</CODE>
     ...
     * @throws IllegalArgumentException The specified value does not correspond to an IP address.
     * @see SnmpIpAddress
     */
