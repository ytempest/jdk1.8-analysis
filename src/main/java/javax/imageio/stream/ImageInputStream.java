...
public interface ImageInputStream extends DataInput, Closeable {
     ...
     * @param len the maximum number of <code>byte</code>s to read.
     * @throws IndexOutOfBoundsException if <code>len</code> is
     *                                   negative.
     ...
     * @throws IllegalArgumentException if <code>bitOffset</code>
     ...
     * @throws IllegalArgumentException if <code>numBits</code>
     ...
     * @throws IndexOutOfBoundsException if <code>pos</code> lies
