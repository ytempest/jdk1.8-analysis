...
public abstract class MessageFactory {
     ...
     * @throws SOAPException if there was an error in creating the
     ...
     * @throws UnsupportedOperationException if the protocol of this
     ...
     * @throws IOException              if there is a problem in reading data from
     *                                  the input stream
     * @throws SOAPException            may be thrown if the message is invalid
     * @throws IllegalArgumentException if the <code>MessageFactory</code>
