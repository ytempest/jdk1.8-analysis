...
public abstract class AttachmentMarshaller {
     ...
     * @return a valid content-id URI (see <a href="http://www.w3.org/TR/xop10/#RFC2387">RFC 2387</a>) that identifies the attachment containing <code>data</code>.
     ...
     *
     * @param data represents the data to be attached. Must be non-null.
     * @return must be a valid URI used as cid. Must satisfy Conformance Requirement R2928 from
