...
final public class DatatypeConverter {
     ...
     * @throws SecurityException        If the {@link SecurityManager} in charge denies the access to
     ...
     *
     * @param lexicalXSDString A string containing a lexical representation of
     *                         xsd:string.
     ...
     *
     * @param lexicalXSDInteger A string containing a lexical representation of
     *                          xsd:integer.
     ...
     *
     * @param lexicalXSDInt A string containing a lexical representation of
     *                      xsd:int.
     ...
     *
     * @param lexicalXSDLong A string containing lexical representation of
     *                       xsd:long.
     ...
     *
     * @param lexicalXSDShort A string containing lexical representation of
     *                        xsd:short.
     ...
     *
     * @param lexicalXSDDecimal A string containing lexical representation of
     *                          xsd:decimal.
     ...
     *
     * @param lexicalXSDFloat A string containing lexical representation of
     *                        xsd:float.
     ...
     *
     * @param lexicalXSDDouble A string containing lexical representation of
     *                         xsd:double.
     ...
     *
     * @param lexicalXSDBoolean A string containing lexical representation of
     *                          xsd:boolean.
     ...
     *
     * @param lexicalXSDByte A string containing lexical representation of
     *                       xsd:byte.
     ...
     *
     * @param lexicalXSDDateTime A string containing lexical representation of
     *                           xsd:datetime.
     ...
     *
     * @param lexicalXSDUnsignedShort A string containing lexical
     ...
     * Converts the string argument into a Calendar value.
     *
     * @param lexicalXSDTime A string containing lexical representation of
     *                       xsd:time.
     ...
     * Converts the string argument into a Calendar value.
     *
     * @param lexicalXSDDate A string containing lexical representation of
     *                       xsd:Date.
     * @return A Calendar value represented by the string argument.
     ...
     * simple type.
     *
     * @param lexicalXSDAnySimpleType A string containing lexical
