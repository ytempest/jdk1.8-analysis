...
public abstract class ResolutionSyntax implements Serializable, Cloneable {
     ...
     *                            {@link    #DPCM DPCM}.
     * @throws IllegalArgumentException (unchecked exception) Thrown if {@code crossFeedResolution < 1}
     ...
     * @param units Unit conversion factor, e.g. {@link #DPI <CODE>DPI</CODE>} or
     ...
     *
     * @param units Unit conversion factor, e.g. {@link #DPI DPI} or {@link
     *              #DPCM DPCM}.
     ...
     *
     * @param units     Unit conversion factor, e.g. {@link #DPI CODE>DPI} or {@link
     *                  #DPCM DPCM}.
     * @param unitsName Units name string, e.g. <CODE>"dpi"</CODE> or <CODE>"dpcm"</CODE>. If
