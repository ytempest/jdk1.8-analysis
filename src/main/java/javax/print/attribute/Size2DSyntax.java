...
public abstract class Size2DSyntax implements Serializable, Cloneable {
     ...
     * @param units Unit conversion factor, e.g. {@link #INCH INCH} or
     *              {@link #MM MM}.
     * @throws IllegalArgumentException (Unchecked exception) Thrown if {@code x < 0} or {@code y < 0}
     *                                  or {@code units < 1}.
     */
     ...
     * @param units Unit conversion factor, e.g. {@link #INCH <CODE>INCH</CODE>} or
     ...
     *
     * @param units Unit conversion factor, e.g. {@link #INCH INCH} or {@link #MM MM}.
