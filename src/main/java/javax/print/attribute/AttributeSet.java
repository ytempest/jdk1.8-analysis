...
public interface AttributeSet {
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if the <CODE>attribute</CODE> is null.
     * @throws UnmodifiableSetException (unchecked exception) Thrown if this attribute set does not support
     ...
     * @throws NullPointerException     (Unchecked exception) Thrown if some element in the specified
     *                                  set is null.
     * @see #add(Attribute)
     */
