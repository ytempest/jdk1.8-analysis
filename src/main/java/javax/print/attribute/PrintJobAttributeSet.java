...
public interface PrintJobAttributeSet extends AttributeSet {
     ...
     * @throws ClassCastException       (unchecked exception) Thrown if the <CODE>attribute</CODE> is
     ...
     * @throws ClassCastException       (Unchecked exception) Thrown if some element in the specified
