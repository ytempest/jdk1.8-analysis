...
public class DocFlavor implements Serializable, Cloneable {
     ...
     * @throws NullPointerException     (unchecked exception) Thrown if <CODE>mimeType</CODE> is null or
     *                                  <CODE>className</CODE> is null.
     * @throws IllegalArgumentException (unchecked exception) Thrown if <CODE>mimeType</CODE> does not
    ...
    public static class BYTE_ARRAY extends DocFlavor {
         ...
         *
         * @param mimeType MIME media type string.
         * @throws NullPointerException     (unchecked exception) Thrown if <CODE>mimeType</CODE> is null.
         * @throws IllegalArgumentException (unchecked exception) Thrown if <CODE>mimeType</CODE> does not
         *                                  obey the syntax for a MIME media type string.
         */
    ...
    public static class SERVICE_FORMATTED extends DocFlavor {
         ...
         *
         * @param className Fully-qualified representation class name.
         * @throws NullPointerException (unchecked exception) Thrown if <CODE>className</CODE> is
         *                              null.
         */
