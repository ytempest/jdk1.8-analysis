...
public interface ModelMBeanNotificationBroadcaster extends NotificationBroadcaster {
     ...
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException: The AttributeChangeNotification object passed in parameter is null.
     */
     ...
     *                 </PRE>
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException: An Attribute object passed in parameter is null
     ...
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException The attribute name passed in parameter does not exist.
     ...
     * @throws ListenerNotFoundException  The listener is not registered in the MBean or is null.
     * @throws MBeanException             Wraps a distributed communication Exception.
     * @throws RuntimeOperationsException Wraps an IllegalArgumentException If the inAttributeName parameter does not
